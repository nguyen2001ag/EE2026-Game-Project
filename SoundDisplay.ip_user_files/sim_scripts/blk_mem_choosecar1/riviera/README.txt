...
#
# Generated by export_simulation on Sat Apr 04 09:21:46 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_choosecar1.sh' script.

./blk_mem_choosecar1.sh -reset_run
...
./blk_mem_choosecar1.sh -noclean_files

For more information on the script, please type './blk_mem_choosecar1.sh -help'.
