...
#
# Generated by export_simulation on Sat Apr 04 20:06:34 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_choosetrack2.sh' script.

./blk_mem_choosetrack2.sh -reset_run
...
./blk_mem_choosetrack2.sh -noclean_files

For more information on the script, please type './blk_mem_choosetrack2.sh -help'.
