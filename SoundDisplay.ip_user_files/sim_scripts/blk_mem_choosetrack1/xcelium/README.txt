...
#
# Generated by export_simulation on Sat Apr 04 09:24:19 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_choosetrack1.sh' script.

./blk_mem_choosetrack1.sh -reset_run
...
./blk_mem_choosetrack1.sh -noclean_files

For more information on the script, please type './blk_mem_choosetrack1.sh -help'.
