...
HD_PWD='D:/Vivado/Project/Final/SoundDisplay/SoundDisplay.runs/blk_mem_choosecar2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_choosecar2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_choosecar2.tcl
