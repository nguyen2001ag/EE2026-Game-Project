...
HD_PWD='D:/Vivado/Project/Final/SoundDisplay/SoundDisplay.runs/blk_mem_gameover_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gameover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gameover.tcl
